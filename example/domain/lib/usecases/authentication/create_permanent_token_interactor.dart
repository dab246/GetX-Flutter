...
import 'package:domain/state/create_permanent_token_state.dart';
...
class CreatePermanentTokenInteractor {
  ...
  Future<Either<Failure, Success>> execute(Uri baseUrl, UserName userName, Password password) async {
    try {
      ...
      return Right(CreatePermanentTokenSuccess(token));
    } catch (exception) {
      return Left(CreatePermanentTokenFailure(exception));
    }
  }
}