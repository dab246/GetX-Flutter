...
import 'package:domain/state/delete_permanent_token_state.dart';
...
class DeletePermanentTokenInteractor {
  ...
  Future<Either<Failure, Success>> execute() async {
    try {
      ...
      return Right(DeletePermanentTokenSuccess());
    } catch (exception) {
      return Left(DeletePermanentTokenFailure(exception));
    }
  }
}
